...
behavior_patterns = {
    "32bit": {
        ...
        "shadow_string": [
            ...
            # Stack push patterns for /etc/shadow (common in 32-bit)
        ...
        "hosts_string": [
            ...
            # Stack push patterns for /etc/hosts (common in 32-bit)
        ...
        "shadow_entry": [
            # Common shadow file manipulation patterns
        ...
        "hosts_entry": [
            # Common hosts file manipulation patterns
            ...
            # IP addresses commonly used in DNS hijacking
            bytes([0x31, 0x39, 0x32, 0x2e, 0x31, 0x36, 0x38]),  # 192.168
            bytes([0x31, 0x30, 0x2e, 0x30, 0x2e]),  # 10.0.
            # Common domains targeted for redirection
            bytes([0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6f, 0x6d]),  # google.com
            bytes([0x66, 0x61, 0x63, 0x65, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x63, 0x6f, 0x6d]),  # facebook.com
            bytes([0x70, 0x61, 0x79, 0x70, 0x61, 0x6c, 0x2e, 0x63, 0x6f, 0x6d]),  # paypal.com
        ],
        "specific": [
